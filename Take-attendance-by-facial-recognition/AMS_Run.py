...
window = tk.Tk()
window.title("Take-attendance-by-facial-recognition")
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'D:/PycharmProject/venv/Face-Recognition-Attendance/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\PycharmProject\venv\Face-Recognition-Attendance\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'D:/PycharmProject/venv/Face-Recognition-Attendance/Face-Recognition-Attendance-System-main' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\PycharmProject\venv\Face-Recognition-Attendance\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'khale':
            if password == 'khale123':
                ...
                cs = 'D:/PycharmProject/venv/Face-Recognition-Attendance/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Take attendance by facial recognition", bg="black", fg="white", width=50,
